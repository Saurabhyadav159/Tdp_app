              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    Row(
                      children: List.generate(firstFourImages.length, (index) {
                        final isSelected = _selectedProtocolImageUrl == firstFourImages[index].imageUrl;
                        return GestureDetector(
                          onTap: () {
                            if (isSelected) {
                              // If already selected, deselect it
                              onSelect(-1); // Pass -1 or handle null in parent
                            } else {
                              onSelect(index);
                            }
                          },
                    ...
                    if (remainingImages.isNotEmpty)
                      Row(
                        children: List.generate(remainingImages.length, (index) {
                          final globalIndex = maxVisible + index;
                          final isSelected = _selectedProtocolImageUrl == remainingImages[index].imageUrl;
                          return GestureDetector(
                            onTap: () {
                              if (isSelected) {
